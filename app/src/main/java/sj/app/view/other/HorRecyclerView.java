package sj.app.view.other;//package sjh.com.mvplogin.view.other;
//
...
//
//public class HorRecyclerView extends RelativeLayout {
//
//    //头部title布局
...
//    }
//
//    public HorRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
