...
public class HomeActivity extends AppCompatActivity implements IHomeActivity, View.OnClickListener {
    ...
    private ImageView bt1_;
    private ImageView bt2_;
    private ImageView bt3_;
    private ImageView bt4_;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bt1_ = findViewById(R.id.btn_home_frag1_);
        bt2_ = findViewById(R.id.btn_home_frag2_);
        bt3_ = findViewById(R.id.btn_home_frag3_);
        bt4_ = findViewById(R.id.btn_home_frag4_);
        pages();
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.btn_home_frag1:
                bt1_.setBackgroundResource(R.drawable.page11);
                bt2_.setBackgroundResource(R.drawable.page2);
                bt3_.setBackgroundResource(R.drawable.page3);
                bt4_.setBackgroundResource(R.drawable.page4);
                iter.showFrag(1,mft,list.get(0),list.get(1),list.get(2),list.get(3));
                break;
            case R.id.btn_home_frag2:
                bt1_.setBackgroundResource(R.drawable.page1);
                bt2_.setBackgroundResource(R.drawable.page22);
                bt3_.setBackgroundResource(R.drawable.page3);
                bt4_.setBackgroundResource(R.drawable.page4);
            ...
            case R.id.btn_home_frag3:
                bt1_.setBackgroundResource(R.drawable.page1);
                bt2_.setBackgroundResource(R.drawable.page2);
                bt3_.setBackgroundResource(R.drawable.page33);
                bt4_.setBackgroundResource(R.drawable.page4);
            ...
            case R.id.btn_home_frag4:
                ...
                bt2_.setBackgroundResource(R.drawable.page2);
                bt3_.setBackgroundResource(R.drawable.page3);
                bt4_.setBackgroundResource(R.drawable.page44);
